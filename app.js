...
var createNewTaskElement=function(taskString){
  ...
  deleteButton.className='task__delete-button button';
  deleteButtonImg.src='./remove.svg';
  deleteButtonImg.className='task__delete-button-image';
...
var editTask=function(){
  ...
  var editInput=listItem.querySelector('.task__field');
  ...
  if(containsClass){
    ...
    editInput.classList.add('field_invisible');
    editInput.classList.remove('field_visible');
  }else{
    editInput.value=label.innerText;
    editBtn.innerText='Save';

    editInput.classList.add('field_visible');
    editInput.classList.remove('field_invisible');
  }

  //toggle .editmode on the parent.
//   editInput.classList.toggle('field_invisible');
